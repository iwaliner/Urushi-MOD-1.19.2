...
public class MetalElementTier1CraftingRecipeCategory implements IRecipeCategory<MetalElementTier1CraftingRecipe> {
    ...
    protected void drawReiryoku(MetalElementTier1CraftingRecipe recipe, PoseStack poseStack, int y) {
    ...
    @Override
    public void draw(MetalElementTier1CraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
