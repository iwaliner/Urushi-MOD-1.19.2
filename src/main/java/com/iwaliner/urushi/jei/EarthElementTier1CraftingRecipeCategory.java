...
public class EarthElementTier1CraftingRecipeCategory implements IRecipeCategory<EarthElementTier1CraftingRecipe> {
    ...
    protected void drawReiryoku(EarthElementTier1CraftingRecipe recipe, PoseStack poseStack, int y) {
    ...
    @Override
    public void draw(EarthElementTier1CraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
