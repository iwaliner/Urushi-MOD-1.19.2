...
public class EarthElementTier2CraftingRecipeCategory implements IRecipeCategory<EarthElementTier2CraftingRecipe> {
    ...
    protected void drawReiryoku(EarthElementTier2CraftingRecipe recipe, PoseStack poseStack, int y) {
    ...
    @Override
    public void draw(EarthElementTier2CraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
