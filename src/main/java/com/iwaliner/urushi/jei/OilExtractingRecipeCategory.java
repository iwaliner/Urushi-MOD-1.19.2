...
public class OilExtractingRecipeCategory implements IRecipeCategory<OilExtractingRecipe> {
    public static final ResourceLocation location=new ResourceLocation(ModCoreUrushi.ModID,"oil_extracting");
    ...
    @Override
    public void draw(OilExtractingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
