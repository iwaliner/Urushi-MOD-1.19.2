...
import com.iwaliner.urushi.entiity.food.OhagiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class OhagiFoodRenderer<T extends OhagiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public OhagiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceCakeFoodModel<>(context.bakeLayer(ClientSetUp.RICE_CAKE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/mochi_ohagi.png");
    }
    ...
    public ResourceLocation getTextureLocation(OhagiFoodEntity p_110775_1_) {
