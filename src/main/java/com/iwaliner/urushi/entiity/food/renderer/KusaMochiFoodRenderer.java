...
import com.iwaliner.urushi.entiity.food.KusaMochiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class KusaMochiFoodRenderer<T extends KusaMochiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public KusaMochiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceCakeFoodModel<>(context.bakeLayer(ClientSetUp.RICE_CAKE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/mochi_kusa.png");
    }
    ...
    public ResourceLocation getTextureLocation(KusaMochiFoodEntity p_110775_1_) {
