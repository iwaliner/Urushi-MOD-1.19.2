...
import com.iwaliner.urushi.entiity.food.GravelSushiFoodEntity;
import com.iwaliner.urushi.entiity.food.SquidSushiFoodEntity;
...
public class GravelSushiFoodRenderer<T extends GravelSushiFoodEntity> extends EntityRenderer<T> {
    ...
    public GravelSushiFoodRenderer(EntityRendererProvider.Context context) {
        ...
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gravel_sushi.png");
    }
