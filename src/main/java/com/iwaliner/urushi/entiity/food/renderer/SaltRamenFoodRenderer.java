...
import com.iwaliner.urushi.entiity.food.SaltRamenFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class SaltRamenFoodRenderer<T extends SaltRamenFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SaltRamenFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RamenFoodModel<>(context.bakeLayer(ClientSetUp.RAMEN));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/ramen_salt.png");
    }
    ...
    public ResourceLocation getTextureLocation(SaltRamenFoodEntity p_110775_1_) {
