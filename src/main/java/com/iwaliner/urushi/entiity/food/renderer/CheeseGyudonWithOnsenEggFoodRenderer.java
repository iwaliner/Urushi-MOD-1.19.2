...
import com.iwaliner.urushi.entiity.food.CheeseGyudonWithOnsenEggFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class CheeseGyudonWithOnsenEggFoodRenderer<T extends CheeseGyudonWithOnsenEggFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public CheeseGyudonWithOnsenEggFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gyudon_cheese_onsen_egg.png");
    }
    ...
    public ResourceLocation getTextureLocation(CheeseGyudonWithOnsenEggFoodEntity p_110775_1_) {
