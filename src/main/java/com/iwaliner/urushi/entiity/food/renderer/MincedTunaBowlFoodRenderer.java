...
import com.iwaliner.urushi.entiity.food.MincedTunaBowlFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class MincedTunaBowlFoodRenderer<T extends MincedTunaBowlFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public MincedTunaBowlFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/rice_minced_tuna.png");
    }
    ...
    public ResourceLocation getTextureLocation(MincedTunaBowlFoodEntity p_110775_1_) {
