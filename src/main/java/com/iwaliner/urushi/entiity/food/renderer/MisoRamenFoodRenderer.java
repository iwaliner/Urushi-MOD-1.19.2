...
import com.iwaliner.urushi.entiity.food.MisoRamenFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class MisoRamenFoodRenderer<T extends MisoRamenFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public MisoRamenFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RamenFoodModel<>(context.bakeLayer(ClientSetUp.RAMEN));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/ramen_miso.png");
    }
    ...
    public ResourceLocation getTextureLocation(MisoRamenFoodEntity p_110775_1_) {
