...
import com.iwaliner.urushi.entiity.food.TonkotsuRamenFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class TonkotsuRamenFoodRenderer<T extends TonkotsuRamenFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public TonkotsuRamenFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RamenFoodModel<>(context.bakeLayer(ClientSetUp.RAMEN));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/ramen_tonkotsu.png");
    }
    ...
    public ResourceLocation getTextureLocation(TonkotsuRamenFoodEntity p_110775_1_) {
