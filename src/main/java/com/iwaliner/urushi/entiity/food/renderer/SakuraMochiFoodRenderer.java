...
@OnlyIn(Dist.CLIENT)
public class SakuraMochiFoodRenderer<T extends SakuraMochiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SakuraMochiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceCakeFoodModel<>(context.bakeLayer(ClientSetUp.RICE_CAKE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/mochi_sakura.png");
    }
    ...
    public ResourceLocation getTextureLocation(SakuraMochiFoodEntity p_110775_1_) {
