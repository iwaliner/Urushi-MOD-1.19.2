...
import com.iwaliner.urushi.entiity.food.GreenOnionAndRawEggGyudonFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class GreenOnionAndRawEggGyudonFoodRenderer<T extends GreenOnionAndRawEggGyudonFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public GreenOnionAndRawEggGyudonFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gyudon_green_onion.png");
    }
    ...
    public ResourceLocation getTextureLocation(GreenOnionAndRawEggGyudonFoodEntity p_110775_1_) {
