...
import com.iwaliner.urushi.entiity.food.SakuraMochiFoodEntity;
import com.iwaliner.urushi.entiity.food.SoySourceRamenFoodEntity;
import com.iwaliner.urushi.entiity.food.model.RamenFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class SoySourceRamenFoodRenderer<T extends SoySourceRamenFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SoySourceRamenFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RamenFoodModel<>(context.bakeLayer(ClientSetUp.RAMEN));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/ramen_soy_source.png");
    }
    ...
    public ResourceLocation getTextureLocation(SoySourceRamenFoodEntity p_110775_1_) {
