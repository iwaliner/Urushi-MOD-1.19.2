...
import com.iwaliner.urushi.entiity.food.MustardLeafAndCodCaviarGyudonFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class MustardLeafAndCodCaviarGyudonFoodRenderer<T extends MustardLeafAndCodCaviarGyudonFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public MustardLeafAndCodCaviarGyudonFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gyudon_cod.png");
    }
    ...
    public ResourceLocation getTextureLocation(MustardLeafAndCodCaviarGyudonFoodEntity p_110775_1_) {
