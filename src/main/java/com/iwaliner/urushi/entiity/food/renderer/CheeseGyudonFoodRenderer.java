...
import com.iwaliner.urushi.entiity.food.CheeseGyudonFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class CheeseGyudonFoodRenderer<T extends CheeseGyudonFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public CheeseGyudonFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/gyudon_cheese.png");
    }
    ...
    public ResourceLocation getTextureLocation(CheeseGyudonFoodEntity p_110775_1_) {
