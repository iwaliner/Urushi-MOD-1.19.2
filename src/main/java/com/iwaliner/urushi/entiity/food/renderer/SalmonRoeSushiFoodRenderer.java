...
import com.iwaliner.urushi.entiity.food.SalmonSushiFoodEntity;
import com.iwaliner.urushi.entiity.food.model.SalmonRoeSushiFoodModel;
...
public class SalmonRoeSushiFoodRenderer<T extends SalmonRoeSushiFoodEntity> extends EntityRenderer<T> {
    ...
    public SalmonRoeSushiFoodRenderer(EntityRendererProvider.Context context) {
        ...
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/salmon_roe_sushi.png");
    }
