       ...
       // BlockPos.MutableBlockPos blockpos$mutableblockpos1 = blockpos.mutable();
        if (worldgenlevel.isEmptyBlock(blockpos$mutableblockpos)) {
            ...
            //    if (random.nextInt(2) ==0) {
                    ...
                    if(worldgenlevel.getBlockState(blockpos$mutableblockpos.north()).getMaterial()!= Material.AIR&&worldgenlevel.getBlockState(blockpos$mutableblockpos.east()).getMaterial()!= Material.AIR&&worldgenlevel.getBlockState(blockpos$mutableblockpos.south()).getMaterial()!= Material.AIR&&worldgenlevel.getBlockState(blockpos$mutableblockpos.west()).getMaterial()!= Material.AIR) {
